...
BYTE const code bCustomKey4Cmd0B[]={1,0x0B};
BYTE const code bCustomKey4Cmd0C[]={1,0x0c};
BYTE const code bCustomKey4Cmd11[]={1,0x11};
BYTE const code bCustomKey4Cmd13[]={1,0x13};
BYTE const code bCustomKey4Cmd1C[]={1,0x1C};
BYTE const code bCustomKey4Cmd1F[]={1,0x1F};
BYTE const code bCustomKey4Cmd21[]={1,0x21};
BYTE const code bCustomKey4Cmd29[]={1,0x29};
BYTE const code bCustomKey4Cmd3B[]={1,0x3B};
BYTE const code bCustomKey4Cmd4D[]={1,0x4D};
BYTE const code bCustomKey4Cmd51[]={1,0x51};
BYTE const code bCustomKey4Cmd57[]={1,0x57};

BYTE const code bCustomKey4Cmd0402[]={2,0x04,0x02};
BYTE const code bCustomKey4Cmd283f[]={2,0x28,0x3f};
...
void CustomHfunc4Cmd0B();
void CustomHfunc4Cmd0C();
void CustomHfunc4Cmd11();
void CustomHfunc4Cmd13();
void CustomHfunc4Cmd1C();
void CustomHfunc4Cmd1F();
void CustomHfunc4Cmd21();
void CustomHfunc4Cmd29();
void CustomHfunc4Cmd3B();
void CustomHfunc4Cmd4D();
void CustomHfunc4Cmd51();
void CustomHfunc4Cmd57();
void CustomHfunc4Cmd0402();
void CustomHfunc4Cmd283F();
...
BYTE const code CustomRes4Cmd05_05[] = {0xF1,0xB4,0x00,0x00,0xC0,0x5B,0x00,0x00,0x80,0xC7,0x00,0x00,0x92,0x5A,0x00,0x00};
BYTE const code CustomRes4Cmd05_06[] = {0x1E,0xA0,0x00,0x00,0x70,0x3F,0x00,0x00,0x20,0x36,0x01,0x00,0xA0,0xE4,0x00,0x00};
BYTE const code CustomRes4Cmd05_07[] = {0x9B,0x0B,0xD0,0x04,0xD4,0x1F,0x15,0xA1,0x0B,0xDD,0x04,0xD4,0x14,0x15,0x28,0x00};
BYTE const code CustomRes4Cmd05_08[] = {0x98,0x46,0x54,0x50,0x2D,0x33,0x16,0x11,0x13,0x10,0x37,0x53,0x13,0x4A,0x00,0x11};
BYTE const code CustomRes4Cmd05_10[] = {0x9D,0x9E,0x00,0x00,0x12,0x3F,0x00,0x00,0x73,0x2D,0x01,0x00,0x75,0xE2,0x00,0x00};
BYTE const code CustomRes4Cmd05_11[] = {0x49,0x0B,0x98,0x04,0x74,0x25,0x15,0x52,0x0B,0xA5,0x04,0x75,0x1D,0x15,0x24,0x00};
BYTE const code CustomRes4Cmd05_12[] = {0x8C,0x4D,0x46,0x2D,0x33,0x41,0x16,0x11,0x12,0x14,0x25,0xC1,0x14,0xDA,0x02,0x00};
BYTE const code CustomRes4Cmd05_32[] = {0x02,0x01,0x00,0x3A,0x00,0xB0,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};

BYTE const code CustomRes4Cmd3B[] = {0x53,0x33,0x33,0x33,0x30,0x00,0x00,0x00,0x00,0x00};
BYTE const code CustomRes4Cmd4D[] = {0x03,0x03,0x20,0x20,0xff,0x0f,0x01};
BYTE const code CustomRes4Cmd51[] = {0x06,0x30,0x30,0x00,0x9F,0xD4,0x7F,0x0E,0x0F,0x03,0x07,0x07,0x12,0x80,0x50};
BYTE const code CustomRes4CmdFF00[] = {0x34,0x41,0x00,0x0c,0x00,0x28,0x01,0x01,0x06,0x0d,0x27,0x30,0x12,0x01,0x09,0x13,0x00,0x4d,0x00,0x00,0x00,0x00,0x00,0x00};
BYTE const code CustomRes4CmdFF01[] = {0x54,0x01,0x00,0x12,0x68,0x69,0x00,0x00,0x00,0x00,0x00,0x00};
BYTE const code CustomRes4CmdFF03[] = {0x55,0x01,0x00,0x00,0x08,0x09,0x00,0x00,0x00,0x00,0x00,0x00};
BYTE const code CustomRes4CmdFF04[] = {0x51,0x40,0x00,0x02,0x00,0xf0}; 
...
{  
	...
	{bCustomKey4Cmd0B,	CustomHfunc4Cmd0B}, 
 	{bCustomKey4Cmd0C,	CustomHfunc4Cmd0C},	
	{bCustomKey4Cmd11,	CustomHfunc4Cmd11}, 
	{bCustomKey4Cmd13,	CustomHfunc4Cmd13}, 
	{bCustomKey4Cmd1C,	CustomHfunc4Cmd1C}, 
	{bCustomKey4Cmd1F,	CustomHfunc4Cmd1F}, 
	{bCustomKey4Cmd21,	CustomHfunc4Cmd21}, 
	{bCustomKey4Cmd29,	CustomHfunc4Cmd29}, 
	{bCustomKey4Cmd3B,	CustomHfunc4Cmd3B}, 
	{bCustomKey4Cmd4D,	CustomHfunc4Cmd4D}, 
	{bCustomKey4Cmd51,	CustomHfunc4Cmd51}, 
	{bCustomKey4Cmd57,	CustomHfunc4Cmd57}, 

 	{bCustomKey4Cmd0402,	CustomHfunc4Cmd0402},	
	{bCustomKey4Cmd283f,	CustomHfunc4Cmd283F},	
...
BYTE const code bCustomKey4Cmd0100[]={2,0x01,0x00};
BYTE const code bCustomKey4Cmd0400[]={7,0x04,0x00,0x05,0x00,0x2F,0x00,0x00};
BYTE const code bCustomKey4Cmd0402[]={7,0x04,0x00,0x05,0x00,0x2F,0x00,0x02};
BYTE const code bCustomKey4Cmd0403[]={7,0x04,0x00,0x05,0x00,0x2F,0x00,0x03};
BYTE const code bCustomKey4Cmd0404[]={7,0x04,0x00,0x05,0x00,0x2F,0x00,0x04};
BYTE const code bCustomKey4Cmd0405[]={8,0x04,0x00,0x06,0x00,0x2F,0x00,0x05,0xd0};
BYTE const code bCustomKey4Cmd040A[]={12,0x04,0x00,0x0A,0x00,0x2F,0x00,0x22,0x00,0x00,0x24,0x00,0x02};
BYTE const code bCustomKey4Cmd0417[]={13,0x04,0x00,0x0B,0x00,0x40,0x00,0x01,0x3C,0x00,0x00,0xB0,0x42,0x17};
BYTE const code bCustomKey4Cmd040807[]={10,0x04,0x00,0x08,0x00,0x2F,0x00,0x06,0xD0,0x01,0x07};
BYTE const code bCustomKey4Cmd040801[]={10,0x04,0x00,0x08,0x00,0x2F,0x00,0x06,0xD3,0x01,0x01};
BYTE const code bCustomKey4Cmd040815[]={10,0x04,0x00,0x08,0x00,0x2F,0x00,0x06,0xD0,0x01,0x15};
BYTE const code bCustomKey4Cmd040800[]={10,0x04,0x00,0x08,0x00,0x2F,0x00,0x06,0xD3,0x01,0x00};
...
void CustomHfunc4Cmd0100();
void CustomHfunc4Cmd0400();
void CustomHfunc4Cmd0402();
void CustomHfunc4Cmd0403();
void CustomHfunc4Cmd0404();
void CustomHfunc4Cmd0405();
void CustomHfunc4Cmd040A();
void CustomHfunc4Cmd0417();
void CustomHfunc4Cmd040807();
void CustomHfunc4Cmd040801();
void CustomHfunc4Cmd040815();
void CustomHfunc4Cmd040800();
...
BYTE const code CustomRes4Cmd0100_1[] = {0x20,0x00,0x20,0x00,0xFF,0x00,0x00,0x01,0x1D,0x00,0x02,0x00,0x03,0x00,0x00,0x01,0x04,0x00,0x00,0x01,0x05,0x00,0x06,0x00,0xB4,0x04,0x00,0xC1,0x01,0x00,0x00,0x00,0x00,0x00};
BYTE const code CustomRes4Cmd0100_2[] = {0x20,0x00,0x20,0x00,0xF7,0x00,0x00,0x01,0xEC,0x00,0x02,0x00,0x03,0x00,0xFA,0x00,0x04,0x00,0xFA,0x00,0x05,0x00,0x06,0x00,0xB4,0x04,0x01,0xC1,0x00,0x01,0x00,0x00,0x00,0x00};
BYTE const code CustomRes4Cmd0402[] = {0x33,0x00,0x33,0x00,0x1F,0x00,0x82,0x01,0x02,0x08,0x00,0x02,0x00,0x63,0x29,0x0C,0x00,0x10,0x00,0x02,0x00,0x99,0x11,0x1F,0x09,0xFD,0xE3,0x8F,0x03,0x56,0x13,0x05,0x00,0x1E,0x03,0x11,0x1F,0xAF,0x1A,0x70,0x2F,0x38,0x04,0x80,0x07,0xFF,0x00,0x00,0x01,0x00,0x00,0x03,0x0A};
BYTE const code CustomRes4Cmd0400_01[] = {0x05,0x00,0x05,0x00,0x1F,0x00,0x00};
BYTE const code CustomRes4Cmd0400_02[] = {0x05,0x00,0x05,0x00,0x1F,0x00,0x80};
BYTE const code CustomRes4Cmd0403[] = {0x05,0x00,0x05,0x00,0x1F,0x00,0x03};
BYTE const code CustomRes4Cmd0404[] = {0x05,0x00,0x05,0x00,0x1F,0x00,0x04};
BYTE const code CustomRes4Cmd0405[] = {0x08,0x00,0x08,0x00,0x1F,0x00,0x85,0xD0,0x01,0x15};
BYTE const code CustomRes4Cmd040A[] = {0x30,0x00,0x30,0x00,0x1F,0x00,0xA2,0x00,0x02,0x24,0x00,0x00,0x24,0x00,0x3E,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0xF4,0x20,0x11,0x43,0x59,0x53,0x44,0x01,0x10,0x00,0x10,0x03,0x11,0x1F,0x04,0x38,0x07,0x80,0x00,0x00,0x59,0x42};
BYTE const code CustomRes4Cmd040800[] ={0x07,0x00,0x07,0x00,0x1F,0x00,0x86,0xD3,0x01};
BYTE const code CustomRes4Cmd040807[] ={0x07,0x00,0x07,0x00,0x1F,0x00,0x06,0xD0,0x01};


I2CCmdType const code I2CCmd[]= 
{  	
	{bCustomKey4Cmd0100,  CustomHfunc4Cmd0100},
	{bCustomKey4Cmd0400,  CustomHfunc4Cmd0400},
	{bCustomKey4Cmd0402,  CustomHfunc4Cmd0402},
	{bCustomKey4Cmd0403,  CustomHfunc4Cmd0403},
	{bCustomKey4Cmd0404,  CustomHfunc4Cmd0404},
	{bCustomKey4Cmd0405,  CustomHfunc4Cmd0405},
	{bCustomKey4Cmd040A,  CustomHfunc4Cmd040A},
	{bCustomKey4Cmd0417,  CustomHfunc4Cmd0417},
	{bCustomKey4Cmd040800,CustomHfunc4Cmd040800},
	{bCustomKey4Cmd040801,CustomHfunc4Cmd040801},
	{bCustomKey4Cmd040807,CustomHfunc4Cmd040807},
	{bCustomKey4Cmd040815,CustomHfunc4Cmd040815},
	{bCustomKey4CmdFFF101,  CustomHfunc4CmdFFF101},
	{bCustomKey4CmdFFF102, CustomHfunc4CmdFFF102},
	{bCustomKey4CmdFFF103, CustomHfunc4CmdFFF103},
	{bCustomKey4CmdFFFF,  CustomHfunc4CmdFFFF}
...
void CustomHfunc4Cmd06()
{
	if(CustomerVar.WCustomCmd07Cnt < 3)
	{
		BYTE bTmpbuff[] = {0x81};
		CustomerResponseArray(bTmpbuff,1, RESET_RXIDX);  
	}
...
void CustomHfunc4Cmd05()
{
	...
	if(CustomerVar.bCustomCmd05Cnt==5)
	{
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_05,16, RESET_RXIDX); 
	}
	else if(CustomerVar.bCustomCmd05Cnt==6)
	{		
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_06,16, RESET_RXIDX); 
	}
	else if(CustomerVar.bCustomCmd05Cnt==7)
	{		
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_07,16, RESET_RXIDX); 
	}
	else if(CustomerVar.bCustomCmd05Cnt==8)
	{		
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_08,16, RESET_RXIDX); 
	}
	else if(CustomerVar.bCustomCmd05Cnt==10)
	{		
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_10,16, RESET_RXIDX); 
	}
	else if(CustomerVar.bCustomCmd05Cnt==11)
	{		
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_11,16, RESET_RXIDX); 
	}
	else if(CustomerVar.bCustomCmd05Cnt==12)
	{		
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_12,16, RESET_RXIDX); 
	}
	else if(CustomerVar.bCustomCmd05Cnt==32)
	{		
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_32,16, RESET_RXIDX); 
		ZetVar.bWorkingState=WORKING_STATE_CUSTOMER_NORMAL;	
	}
}
void CustomHfunc4Cmd07()
{
	...
	{
		CustomerVar.WCustomCmd07Cnt++;
		if(CustomerVar.WCustomCmd07Cnt==1)
		{
			BYTE bTmpbuff[] = {0x06};
			CustomerResponseArray(bTmpbuff,1, RESET_RXIDX);  
		}
		else if(CustomerVar.WCustomCmd07Cnt==2)
		{
			BYTE bTmpbuff[] = {0x00};
			CustomerResponseArray(bTmpbuff,1, RESET_RXIDX);  
		}
...
void CustomHfunc4Cmd0C()
{
	BYTE bTmpbuff[] = {0xB0,0x07,0x01,0x06,0x00};
	CustomerResponseArray(bTmpbuff,5, RESET_RXIDX);  
}
void CustomHfunc4Cmd11()
{
...
void CustomHfunc4Cmd13()
{
	BYTE bTmpbuff[] = {0x37,0x04,0x7F,0x07};
	CustomerResponseArray(bTmpbuff,4, RESET_RXIDX);  
}
void CustomHfunc4Cmd1C()
{
	BYTE bTmpbuff[] = {0x05,0x0A};
	CustomerResponseArray(bTmpbuff,2, RESET_RXIDX);  
}
void CustomHfunc4Cmd1F()
{
...
void CustomHfunc4Cmd29()
{
	BYTE bTmpbuff[] = {0x03,0x07};
	CustomerResponseArray(bTmpbuff,2, RESET_RXIDX);  
}

void CustomHfunc4Cmd3B()
{
	CustomerResponseArray((BYTE *)CustomRes4Cmd3B,10, RESET_RXIDX); 
}
void CustomHfunc4Cmd4D()
{
	CustomerResponseArray((BYTE *)CustomRes4Cmd4D,8, RESET_RXIDX); 
}
void CustomHfunc4Cmd51()
{
	CustomerResponseArray((BYTE *)CustomRes4Cmd51,15, RESET_RXIDX); 
}
void CustomHfunc4Cmd57()
{
	BYTE bTmpbuff[] = {0x20};
...
void CustomHfunc4CmdFF00()
{
	CustomerResponseArray((BYTE *)CustomRes4CmdFF00,24, RESET_RXIDX); 
}
void CustomHfunc4CmdFF01()
{
	CustomerResponseArray((BYTE *)CustomRes4CmdFF01,12, RESET_RXIDX); 
}
void CustomHfunc4CmdFF03()
{
...
void CustomHfunc4CmdFF04()
{
	CustomerResponseArray((BYTE *)CustomRes4CmdFF04,6, RESET_RXIDX); 
}
...
void CustomHfunc4Cmd0100()
{
	CustomerVar.bCustomCmd0100Cnt++;
	if(CustomerVar.bCustomCmd0100Cnt==1)
	{
		CustomerResponseArray((BYTE *)CustomRes4Cmd0100_1,34, RESET_RXIDX);
		I2C_INT_LOW();
	}
	else if(CustomerVar.bCustomCmd0100Cnt==2)
	{
		CustomerResponseArray((BYTE *)CustomRes4Cmd0100_2,34, RESET_RXIDX); 		
		I2C_INT_LOW();
		ZetVar.bWorkingState = WORKING_STATE_CUSTOMER_NORMAL;
	}
}
...
{	
	...
	CustomerVar.bCustomCmd0400Cnt++;
	if(CustomerVar.bCustomCmd0400Cnt==1)
	{
		CustomerResponseArray((BYTE *)CustomRes4Cmd0400_01,53, RESET_RXIDX); 
	}
	else if(CustomerVar.bCustomCmd0400Cnt==2)
	{
		CustomerVar.bCustomCmd0400Cnt = 0;
		CustomerResponseArray((BYTE *)CustomRes4Cmd0400_02,53, RESET_RXIDX); 		
	}
}
void CustomHfunc4Cmd0402()
{	
	...
	CustomerResponseArray((BYTE *)CustomRes4Cmd0402,53, RESET_RXIDX); 
}
void CustomHfunc4Cmd0403()
{	
	CustomerVar.bINTtriggerCnt = 0;
	CustomerResponseArray((BYTE *)CustomRes4Cmd0403,7, RESET_RXIDX); 
}
void CustomHfunc4Cmd0404()
{	
	CustomerVar.bINTtriggerCnt = 0;
	CustomerResponseArray((BYTE *)CustomRes4Cmd0404,7, RESET_RXIDX); 
}
void CustomHfunc4Cmd0405()
{	
	CustomerVar.bINTtriggerCnt = 0;
	CustomerResponseArray((BYTE *)CustomRes4Cmd0405,10, RESET_RXIDX); 
}

void CustomHfunc4Cmd040A()
{	
	CustomerVar.bINTtriggerCnt = 0;
	CustomerResponseArray((BYTE *)CustomRes4Cmd040A,50, RESET_RXIDX); 
}
void CustomHfunc4Cmd0417()
{
	I2C_INT_LOW();
...
{	
	CustomerVar.bINTtriggerCnt = 0;
	CustomerVar.wTimeToNormal = 1;
	ZetVar.bWorkingState = WORKING_STATE_CUSTOMER_NORMAL;
	CustomerResponseArray((BYTE *)CustomRes4Cmd040800,9, RESET_RXIDX); 
}
void CustomHfunc4Cmd040801()
{	
	CustomerVar.bINTtriggerCnt = 0;
...
{	
	CustomerVar.bINTtriggerCnt = 0;
	CustomerResponseArray((BYTE *)CustomRes4Cmd040807,9, RESET_RXIDX); 
}
void CustomHfunc4Cmd040815()
{	
	CustomerVar.bINTtriggerCnt = 0;
...
void CustomerTxIsrINTControl()
{
	if((ZetVar.bI2CCmd == 0x04)||(ZetVar.bI2CCmd == 0x01))
	{
		I2C_INT_HIGH();
	}
}
