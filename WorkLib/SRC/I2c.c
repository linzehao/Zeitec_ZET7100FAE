...
BYTE const code bCustomKey4Cmd0D[]={1,0x0D};
BYTE const code bCustomKey4Cmd0E81[]={2,0x0E,0x81};
BYTE const code bCustomKey4Cmd0F[]={1,0x0F};
BYTE const code bCustomKey4Cmd10[]={1,0x10};
...
BYTE const code bCustomKey4Cmd3E[]={1,0x3E};
...
void CustomHfunc4Cmd0D();
void CustomHfunc4Cmd0E81();
void CustomHfunc4Cmd0F();
void CustomHfunc4Cmd10();
...
BYTE const code CustomRes4CmdFF00[] = {0x50,0x00,0x15,0x08,0x33,0x2a,0x0E,0x06,0x2b,0x00,0x0d,0x00};
BYTE const code CustomRes4CmdFF04[] = {0x57,0x00,0x19,0x00};
BYTE const code CustomRes4CmdFF01[] = {0x4D,0x4C,0x0E,0x00};
BYTE const code CustomRes4Cmd3E[] = {0x53,0x33,0x37,0x31,0x38,0x41,0x52,0x00,0x00,0x00};
BYTE const code CustomRes4Cmd15[] = {0x37,0x04,0x7F,0x07,0x9f,0x45,0xb5,0x44,0x0c,0x09,0x06,0x0f,0x1C,0x10};
BYTE const code CustomRes4Cmd0f[] = {0x7F,0x2B,0x00,0x0D,0x00,0x41,0x34,0x33,0x2A,0x0E,0x06,0x01,0x01,0x08,0x01,0x07,0x62,0x8C,0x25,0x00,0x04,0x10,0x00,0x80,0x00,0x80,0x2D,0x80,0x00,0x00,0x04,0xFE,0x03,0x00,0x00};
BYTE const code CustomRes4Cmd05_1[] = {0x00,0x00,0x01,0x00,0x00,0x02,0x00,0x00,0x24,0x05,0x02,0x00,0x01,0x00,0xFF,0x01,0x07,0x06,0x03,0x00,0x80,0x00,0x00,0x02,0x27,0x02,0x06,0x00,0x80,0x00,0x80,0x02,0x2F,0x10,0x07,0x00,0x80,0x1C,0x00,\
									 0x03,0x64,0x1B,0x08,0x00,0x80,0x00,0x80,0x1F,0x67,0x1A,0x09,0x00,0x00,0x10,0x00,0x20,0x64,0x1A,0x05,0x00,0x20,0x00,0x00,0x40,0x0F,0x00,0x04,0x00,0x60,0x00,0x20,0x40,0x03,0x00};
BYTE const code CustomRes4Cmd05_2[] = {0x01,0x05,0x08,0x00,0x01,0x0B};
...
BYTE  const code CustomRes4CmdDoubleclick_0A[] = {0x03,0x02,0x02,0x93,0x04};
BYTE  const code CustomRes4CmdDoubleclick_00[] = {0x01,0x02,0x85,0x04,0x02,0x02,0x93,0x04};
BYTE  const code CustomRes4CmdDoubleclick_08[] = {0x02,0x02,0x93,0x04,0x02,0x02,0x93,0x04};
...
{ 
	...
	{bCustomKey4Cmd0D,	CustomHfunc4Cmd0D}, 	
	{bCustomKey4Cmd0E81,	CustomHfunc4Cmd0E81}, 	
	{bCustomKey4Cmd0F,	CustomHfunc4Cmd0F}, 	
	{bCustomKey4Cmd13,	CustomHfunc4Cmd13}, 
	{bCustomKey4Cmd15,	CustomHfunc4Cmd15}, 
	{bCustomKey4Cmd18,	CustomHfunc4Cmd18}, 
	{bCustomKey4Cmd3E,	CustomHfunc4Cmd3E}, 
...
void CustomHfunc4Cmd05()
{
	if(CustomerVar.bCustomCmd05Cnt==0)
	{
		...
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_1,76 ,RESET_RXIDX); 
	}
	else 
	{
		CustomerVar.bCustomCmd07Cnt = 1;
		CustomerResponseArray((BYTE *)CustomRes4Cmd05_2,6 ,RESET_RXIDX); 
	}
}
void CustomHfunc4Cmd06()
{
	if(ZetVar.bWorkingState==WORKING_STATE_CUSTOMER_INITIAL)
	{
		if(CustomerVar.bCustomCmd06Cnt==0)
		{
			BYTE bTmpbuff[] = {0X81};
			CustomerResponseArray(bTmpbuff,1, RESET_RXIDX);  
		}
		else if(CustomerVar.bCustomCmd06Cnt==1)
		{
			BYTE bTmpbuff[] = {0X00};
			CustomerResponseArray(bTmpbuff,1, RESET_RXIDX);  
		}
		else if(CustomerVar.bCustomCmd06Cnt==2)
		{
			BYTE bTmpbuff[] = {0x81,0x02};
...
void CustomHfunc4Cmd07()
{
	if(CustomerVar.bCustomCmd07Cnt==0)
	{
		BYTE bTmpbuff[] = {0X00};
		CustomerResponseArray(bTmpbuff,1, RESET_RXIDX);  
	}
...
void CustomHfunc4Cmd0A()
{
	...
	{
		case 11:
				CustomerResponseArray((BYTE *)CustomRes4CmdDoubleclick_0A,5, RESET_RXIDX); 
				break;//doubleclick
...
void CustomHfunc4Cmd08()
{
	...
	else if(ZetVar.bWorkingState==WORKING_STATE_CUSTOMER_GESTURE)
	{
		switch(ZetVar.bReportGestureId)
		{
			case 11:
...
void CustomHfunc4Cmd0D()
{
	BYTE bTmpbuff[] = {0x15,0x80,0x11,0x27};
	CustomerResponseArray(bTmpbuff,4, RESET_RXIDX);  
}
...
void CustomHfunc4Cmd0F()
{
	...
	{
		CustomerResponseArray((BYTE *)CustomRes4Cmd0f,35, RESET_RXIDX); 
	}
}
void CustomHfunc4Cmd10()
{
	...
	{
		case 11:
				CustomerResponseArray((BYTE *)CustomRes4CmdDoubleclick_08,8, RESET_RXIDX); 
				break;//doubleclick
		case 48:
				CustomerResponseArray((BYTE *)CustomRes4CmdO_00,8, RESET_RXIDX); 
				break;//O
...
void CustomHfunc4Cmd46()
{	
	BYTE bTmpbuff[] = {0x38,0x10};
	CustomerResponseArray(bTmpbuff,2, RESET_RXIDX); 
}
void CustomHfunc4Cmd4D()
{	
	BYTE bTmpbuff[] = {0x47};
	CustomerVar.bCustomCmd06Cnt = 2;
...
void CustomHfunc4Cmd15()
{
	CustomerVar.bCustomCmd06Cnt = 1;
	CustomerResponseArray((BYTE *)CustomRes4Cmd15,14, RESET_RXIDX); 
}
void CustomHfunc4Cmd18()
{
	BYTE bTmpbuff[] = {0X00};
...
void CustomHfunc4Cmd0E81()
{
	ZetVar.bWorkingState=WORKING_STATE_CUSTOMER_GESTURE;
}

void CustomHfunc4Cmd3E()
{
	CustomerResponseArray((BYTE *)CustomRes4Cmd3E,10, RESET_RXIDX); 
}
void CustomHfunc4CmdFF00()
{
	I2C_INT_HIGH();
